...
|Year|Title|Authors|Approach|Resources|
|---|---|---|---|---|
|2018|[End-to-end equalization with convolutional neural networks](https://marquetem.files.wordpress.com/2018/09/end-end-equalization-martinez_reiss.pdf)|M. A. MartÌ_nez RamÌ_rez and J. D. Reiss|ML|No|
...
|2017|[Analysis and prediction of the audio feature space when mixing raw recordings into individual stems](http://www.aes.org/e-lib/browse.cfm?elib=19245)|M. A. MartÌ_nez RamÌ_rez and J. D. Reiss|ML|[Yes](https://github.com/mchijmma/audioFeatures-stemMixing)|
